...
This will build RGNCoin-Qt as well if the dependencies are met.
...
If you want to build RGNCoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a rgncoin-qt executable will be
built by default.
