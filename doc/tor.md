...
config file):
	...
	HiddenServicePort 23665 127.0.0.1:23665
	HiddenServicePort 43665 127.0.0.1:43665

The directory can be different of course, but (both) port numbers should be equal to
your dogecoind's P2P listen port (23665 by default).
...
and open port 23665 on your firewall (or use -upnp).
